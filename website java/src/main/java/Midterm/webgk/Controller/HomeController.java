...
public class HomeController {
    ...
    @Autowired
    public HomeController(ProductSerivce productService, CategoryService categoryService, CompanyService companyService, BrandService brandService) {
    ...
    public String filterByCategory( @RequestParam(value = "categoryID", required = false) Integer categoryId, @RequestParam(value = "companyID", required = false) Integer companyId, @RequestParam(value = "brandID", required = false) Integer brandId, @RequestParam(value = "price", required = false) Integer prices, Model model) {
